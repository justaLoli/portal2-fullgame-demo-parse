...
exports.SourceTimer = exports.TimingResult = void 0;
...
exports.TimingResult = TimingResult;
class SourceTimer {
    ...
    checkRules(demo, type) {
        ...
        let oldPosition = new Vector_js_1.Vector(0, 0, 0);
        let oldCommands = [];
        demo.findMessages(messages_js_1.Packet).forEach(({ tick, cmdInfo }) => {
        ...
        demo.findMessages(messages_js_1.ConsoleCmd).forEach(({ tick, command }) => {
        ...
        if (matches.length > 0) {
            ...
            const matchOffset = matches[0].rule.type === 'start'
...
exports.SourceTimer = SourceTimer;
